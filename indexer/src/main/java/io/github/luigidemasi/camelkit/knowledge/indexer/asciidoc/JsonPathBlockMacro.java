 ...
 *
 * <p>Camel docs use {@code jsonpathBlock::} for API-based components to render
 * complex per-method documentation. For indexing purposes, these blocks are
 * skipped — the component's main description and option tables provide
 * sufficient coverage.
 */
@Name("jsonpathBlock")
